...
$(document).ready(function () {
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        ${userRole === 'admin' ? `
                            <button class="btn btn-warning edit-product" data-id="${product.productID}" data-name="${product.productName}" data-price="${product.productPrice}" data-imageurl="${product.imageUrl}">Módosítás</button>
    ...
    $('#editProductForm').submit(function (e) {
        ...
        const imageUrl = $('#editImageUrl').val().trim();

        if (productName && !isNaN(productPrice)) {
            $.post('/Product/UpdateProduct', { productID: productId, productName: productName, productPrice: productPrice, imageUrl: imageUrl }, function (response) {
