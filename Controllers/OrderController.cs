...
public class OrderController : Controller
{
                                 ...
                                 [FromForm] string orderDate)
    {
        ...
        using (var connection = DatabaseConnector.CreateNewConnection())
        {
            string sql = @"
            INSERT INTO ""Order"" 
            (UserID, CustomerName, CustomerEmail, CustomerAddress, HouseNumber, ProductID, ProductName, Price, Amount, Status, OrderDate)
            VALUES (@UserID, @CustomerName, @CustomerEmail, @CustomerAddress, @HouseNumber, @ProductID, @ProductName, @Price, @Amount, @Status, @OrderDate)";
